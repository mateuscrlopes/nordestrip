                          ...
                          <div className="flex shrink-0 items-center gap-2">
                            ...
                            <RecordActions
                              ...
                              fields={[
                                ...
                                {
                                  name: "payment_timing",
                                  label: "Quando será pago",
                                  type: "select",
                                  options: [
                                    { value: "pay_now", label: "Pago na reserva" },
                                    { value: "prepaid", label: "Cobrança antecipada" },
                                    { value: "at_property", label: "Pago na acomodação" },
                                    { value: "partial", label: "Pagamento parcial" },
                                  ],
                                },
                                { name: "payment_due_at", label: "Próxima cobrança", type: "datetime-local" },
                                {
                                  name: "payer_user_id",
                                  label: "Quem vai pagar",
                                  type: "select",
                                  options: participants.members.map((member) => ({
                                    value: member.userId,
                                ...
                                },
                                {
                                  ...
                                  type: "select",
                                  options: [
                                    { value: "credit_card", label: "Cartão pessoal" },
                                ...
                                { name: "planned_installments", label: "Parcelas previstas", type: "number", min: "1", step: "1" },
                                { name: "first_card_due_at", label: "1ª fatura", type: "datetime-local" },
                              ...
                              values={{
                                ...
                                payment_timing: reservation.payment_timing ?? null,
                                payment_due_at: reservation.payment_due_at ?? null,
                                payer_user_id: reservation.payer_user_id ?? null,
                                payment_method: reservation.payment_method ?? null,
                                planned_installments: reservation.planned_installments ?? 1,
                                first_card_due_at: reservation.first_card_due_at ?? null,
